...
DEFAULT_EVALUATION_SET: tuple[EvaluationExample, ...] = (
    ...
    EvaluationExample("What risk does Microsoft describe around cloud competition?", "Microsoft describes intense competition across cloud platforms and services that can pressure pricing, margins, and market share.", "Microsoft", "10-K"),
    EvaluationExample("How does Nvidia describe demand for accelerated computing?", "Nvidia describes strong demand for accelerated computing, data center, AI, and related GPU platforms.", "Nvidia", "10-K"),
    ...
    EvaluationExample("What does Meta identify as its core advertising business?", "Meta identifies advertising across its family of apps as its primary revenue source.", "Meta", "10-K"),
    EvaluationExample("What does Tesla say about automotive revenue?", "Tesla reports automotive revenue from sales and leasing of electric vehicles and related services.", "Tesla", "10-K"),
    ...
    EvaluationExample("What does JPMorgan Chase report as major business segments?", "JPMorgan Chase reports segments such as Consumer and Community Banking, Commercial and Investment Bank, Asset and Wealth Management, and Corporate.", "JPMorgan Chase", "10-K"),
    ...
    EvaluationExample("What table shows Microsoft's revenue by segment?", "Microsoft's filing includes tables breaking revenue down by business segment and product or service group.", "Microsoft", "10-K"),
    EvaluationExample("What table shows Nvidia revenue by market platform?", "Nvidia's filing includes revenue tables by market platform such as data center and gaming.", "Nvidia", "10-K"),
    ...
    EvaluationExample("What recent quarterly filing discusses Meta capital expenditures?", "Meta's 10-Q discusses capital expenditures in relation to infrastructure, servers, data centers, and AI investments.", "Meta", "10-Q"),
    EvaluationExample("What recent quarterly filing discusses Tesla production or deliveries?", "Tesla's 10-Q discusses automotive production, deliveries, revenue, and related operating trends.", "Tesla", "10-Q"),
    ...
    EvaluationExample("What does JPMorgan's quarterly filing say about net interest income?", "JPMorgan's 10-Q discusses net interest income as a key banking performance driver.", "JPMorgan Chase", "10-Q"),
    ...
    EvaluationExample("Which company reports Family of Apps advertising revenue?", "Meta reports advertising revenue from its Family of Apps.", None, "10-K"),
    EvaluationExample("Which company reports automotive gross margin context?", "Tesla reports automotive revenue, cost, gross profit, and margin context.", None, "10-Q"),
